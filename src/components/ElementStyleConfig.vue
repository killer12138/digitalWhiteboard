...
<template>
  ...
  <template v-else-if="isTextElement">
    <ColorPicker size="small" :value="textColor ?? '#000000'" @update:value="updateTextColor" />
  ...
  <LayerControls
    v-if="elementType"
    :can-bring-forward="canBringForward ?? false"
    :can-send-backward="canSendBackward ?? false"
